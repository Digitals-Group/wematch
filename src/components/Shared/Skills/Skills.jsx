  ...
  return (
    <section className="bg-white shadow-sm shadow-gray-300 p-6 mb-4">
      ...
      {educationData
        ...
        .map((edu) => (
          <div className="mb-6">
            ...
            <p className="text-[#313D44] font-inter font-normal text-[16px] leading-6">{edu?.text}</p>
          </div>
        ))}
      {educationData.length > 1 && (
        ...
        >
          <p className="text-[#313D44] font-inter font-normal text-[16px] leading-[24px]">{showMore ? "Show less" : "Show more"}</p>
