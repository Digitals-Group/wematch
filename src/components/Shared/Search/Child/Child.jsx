...
const Child = ({ viewImage, viewText, viewTitle, viewLocation, viewBody }) => {
  return (
    <div className="bg-white flex gap-4 mb-6 rounded-[20px] pt-4 pr-[14px] pb-[36px] pl-4">
      ...
      />
      <div>
        <span className="bg-[#98A3AE29] rounded-[4px] text-[#24292E] py-[4px] pr-[39px] pl-[20px] font-inter font-normal text-[12.4px] leading-4">
          {viewText}
        </span>
        <div className="mt-[15px]">
          ...
          <p className="text-[#24292E] font-normal font-inter text-[15px] leading-5">
            {viewBody}
          </p>
        </div>
      </div>
